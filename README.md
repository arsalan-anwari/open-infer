> LIBRARY IS NO LONGER MAINTAINED AND WILL BE ABANDONED. SOME CONCEPTS WILL BE
> REUSED FOR ANOTHER LIBRARY `zinfer` OPTIMZED FOR LOW POWER INFERENCE
> MAIN REASONS: NO VALID USECASE AND FEATURE CREEP
